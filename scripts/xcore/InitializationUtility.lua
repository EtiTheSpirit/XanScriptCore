...
-- IMPORTANT NOTE: THIS IS A VERY ODD SCRIPT IN THAT IT MUST BE REQUIRED AT THE *BOTTOM* OF A SCRIPT, *NOT* AT THE TOP!
-- IMPORTANT NOTE: THIS IS A VERY ODD SCRIPT IN THAT IT MUST BE REQUIRED AT THE *BOTTOM* OF A SCRIPT, *NOT* AT THE TOP!
-- IMPORTANT NOTE: THIS IS A VERY ODD SCRIPT IN THAT IT MUST BE REQUIRED AT THE *BOTTOM* OF A SCRIPT, *NOT* AT THE TOP!
...
function init()
	...
	if postinit == nil then
		warn("Script has employed the use of initutil but does not specify a postinit() function!")
		return
	end
